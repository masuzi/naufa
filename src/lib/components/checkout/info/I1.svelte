<script>
  ...
  const mbank_l = [
    ...
    ibank_l = [
      ...
      'Masukkan 16 digit nomor Virtual Account yang tertera pada halaman konfirmasi (Contoh: 988002XXXXXXXXXX). Lalu pilih rekening debet yang akan digunakan. Kemudian tekan Lanjut.',
    ...
    atm_l = [
      ...
      'Masukkan 16 digit nomor Virtual Account yang tertera pada halaman konfirmasi (Contoh: 988002XXXXXXXXXX). ',
      'Tagihan yang harus dibayarkan akan muncul pada layar konfirmasi.',
    ...
    atmb_l = [
      ...
      'Masukkan kode bank BNI (009) diikuti dengan 16 digit nomor Virtual Account yang tertera pada halaman konfirmasi (Contoh: 988002XXXXXXXXXX).',
