...
<script>
  export let value = 10
  export let arrows = '60,70,90'
  export let thresholds = '60,70,90'
  export let colors = '#F97316,#2DD4BF,#38BDF8'
